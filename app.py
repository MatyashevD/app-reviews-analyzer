...
def main():
    ...
    if results["app_store"]:
        with st.container():
            st.markdown('<div class="platform-section">', unsafe_allow_html=True)
            st.markdown('### 📱 App Store', unsafe_allow_html=True)
    ...
    if results["google_play"]:
        with st.container():
            st.markdown('<div class="platform-section">', unsafe_allow_html=True)
            st.markdown('### 📲 Google Play', unsafe_allow_html=True)
